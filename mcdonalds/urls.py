...
urlpatterns = [
    ...
    path('suppliers_contact/update/<int:supplier_id>/', views.update_suppliers_contact, name='update_suppliers_contact'),
    path('suppliers_contact/delete/<int:supplier_id>/', views.delete_suppliers_contact, name='delete_suppliers_contact'),
